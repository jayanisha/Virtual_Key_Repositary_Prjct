...
public class Project_1_Phase implements InterfaceFile {

	List<String> retrieve= new ArrayList<String>();
	File[] files = new File("C:\\Users\\ELCOT\\eclipse-workspace\\Phase_1_Project\\src\\phase1_project").listFiles();
	...
	public void searchFile() {
		...
		try {	
			...
			File directory = new File("C:\\Users\\ELCOT\\eclipse-workspace\\Phase_1_Project\\src\\phase1_project");
