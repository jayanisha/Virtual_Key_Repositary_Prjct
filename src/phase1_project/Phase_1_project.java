...
public class Phase_1_project {
	...
	public static void welcomeScreen() {
		...
		System.out.println("Developer Details: Developed by Jayanisha J \n");
	}

	public static void menuDriven() throws FileNotFoundException {
		sc = new Scanner(System.in);
		Project_1_Phase obj = new Project_1_Phase();
		int option;
		do {
		...
		do {
			...
			case 3:
				...
				break;
			case 4:
				System.out.println("Exited from the Project_1_Phase...");
				System.out.println("---------------------------------\n");
				break;
			default:
